...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle bundle) {
        ...
        nameInput = findViewById(R.id.plain_text_input);

        // create adapter to read data to students list
    ...
    public void iAmStudent(View view) {
        codeName = nameInput.getText().toString();
    }
    ...
    // called when teacher clicks "Find Players"
...
//        startDiscovery();
    ...
    // Called when another device's endpoint has been detected (pre-connection)
    // Then, requests a connection with that device
    ...
    private final ConnectionLifecycleCallback connectionLifecycleCallback = new ConnectionLifecycleCallback() {
        ...
        public void onConnectionResult(String endpointId, ConnectionResolution result) {
            if (result.getStatus().isSuccess()) {
                ...
                listItems.add("endpointId: " + endpointId + " and result: " + result.toString());
                adapter.notifyDataSetChanged();
    ...
    private final PayloadCallback payloadCallback = new PayloadCallback() {
        ...
        public void onPayloadReceived(String endpointId, Payload payload) {
            System.out.println("***endpointId: " + endpointId + " and payload: " + new String(payload.asBytes()));

            String currentPayload = new String(payload.asBytes());
            listItems.add(currentPayload);
            adapter.notifyDataSetChanged();
        ...
        public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
            System.out.println("test_breakpoint");
